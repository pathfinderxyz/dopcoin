...
<body class="flat-blue login-page">
    <div class="container">
         <h2 class="titulo-login">Registro exitoso</h2>
         <br>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Ahora eres miembro de nuestra comunidad! esperamos que la pases bien.</div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <a href="../../index.php"><button type="submit" class="btn btn-info">Iniciar Sesion</button></a>
