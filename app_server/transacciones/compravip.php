...
$sqld = pg_query("SELECT * from dopcoinvip");
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Orden de Compra VIP</div> 
                            ...
                            <?php 
                             ...
                             ?>
                                ...
                                <div class="card-body">
                                   ...
                                   <form class="form-horizontal"  action="app_server/transacciones/comprasavevip.php" method="post">
                        ...
                        <div class="col-xs-6">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Tasa de compra VIP</div>
                                    </div>
                                </div>
                                <div class="card-body">
