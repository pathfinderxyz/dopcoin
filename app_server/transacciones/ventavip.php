                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Orden de Venta VIP</div>
                                                       <?php
                                 if ($_GET["compra"]=="no"){
                             ?>
                            ...
                            <?php 
                             ...
                             ?>
                                ...
                                <div class="card-body">
                                   ...
                                   <form class="form-horizontal" action="app_server/transacciones/ventassavevip.php" method="post">
                        ...
                        <div class="col-xs-6">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Tasa de Venta VIP</div>
                                    </div>
                                </div>
                                <div class="card-body">
